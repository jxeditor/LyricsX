...
SLDeclareFunction(MRMediaRemoteGetNowPlayingInfoForPlayer, void, CFTypeRef, Boolean, dispatch_queue_t, void(^)(_Nullable CFDictionaryRef));
SLDeclareFunction(MRMediaRemoteGetNowPlayingClient, void, dispatch_queue_t, void(^)(_Nullable CFTypeRef));
SLDeclareFunction(MRMediaRemoteGetNowPlayingClients, void, dispatch_queue_t, void(^)(CFArrayRef));
SLDeclareFunction(MRMediaRemoteGetNowPlayingApplicationIsPlaying, void, dispatch_queue_t, void(^)(Boolean));
SLDeclareFunction(MRMediaRemoteGetNowPlayingApplicationPID, void, dispatch_queue_t, void(^)(int));

SLDeclareFunction(MRNowPlayingClientGetBundleIdentifier, _Nullable CFStringRef, CFTypeRef);
SLDeclareFunction(MRNowPlayingClientGetDisplayName, _Nullable CFStringRef, CFTypeRef);
SLDeclareFunction(MRNowPlayingClientGetParentAppBundleIdentifier, _Nullable CFStringRef, CFTypeRef);
SLDeclareFunction(MRNowPlayingClientGetProcessIdentifier, int, CFTypeRef);

SLDeclareFunction(MRMediaRemoteRegisterForNowPlayingNotifications, void, dispatch_queue_t);
SLDeclareFunction(MRMediaRemoteSetWantsNowPlayingNotifications, void, Boolean);
