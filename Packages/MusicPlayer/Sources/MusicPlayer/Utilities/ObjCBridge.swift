...
extension MusicPlayerName {
    ...
    init?(lxName: LXScriptingMusicPlayer.Name) {
        ...
        case .netEaseCloudMusic: self = .neteaseCloudMusic
        case .vox: self = .vox
    ...
    static var scriptingPlayerNames: [MusicPlayerName] = [.appleMusic, .spotify, .neteaseCloudMusic, .vox, .audirvana, .swinsian]
}
